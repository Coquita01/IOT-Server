...
from app.domain.roles.controller import role_router
from app.domain.user_roles.controller import user_role_router
...
app.include_router(user_role_router, prefix=api_version_v1_prefix)
